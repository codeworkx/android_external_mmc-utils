...
int do_writeprotect_boot_get(int nargs, char **argv)
{
	...
	CHECK(nargs != 2, "Usage: mmc writeprotect boot get </path/to/mmcblkX>\n",
			  exit(1));
...
int do_writeprotect_boot_set(int nargs, char **argv)
{
	...
	CHECK(nargs != 2, "Usage: mmc writeprotect boot set </path/to/mmcblkX>\n",
			  exit(1));
...
int do_writeprotect_user_get(int nargs, char **argv)
{
	...
	CHECK(nargs != 2, "Usage: mmc writeprotect user get </path/to/mmcblkX>\n", exit(1));
